# This file is removed due to LICENSE file constraints.
# You can copy the m4.py from https://github.com/thuml/Time-Series-Library/blob/main/data_provider/m4.py
